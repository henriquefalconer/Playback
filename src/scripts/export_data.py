...
def collect_files_to_export() -> Tuple[List[Tuple[Path, str]], Dict[str, int]]:
    """
        ...
        for root, dirs, files in os.walk(chunks_dir):
            for file in files:
                ...
                try:
                    ...
                    print(f"[export] Warning: Cannot access {source_path}: {e}")
    ...
    if db_path.exists():
        try:
            ...
            print(f"[export] Warning: Cannot access database {db_path}: {e}")
...
def create_export(
    ...
    files_to_export, stats = collect_files_to_export()
